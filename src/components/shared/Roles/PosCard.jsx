...
import { Avatar, ArrowLeft } from "@global/Icons";
      ...
      <div className="flex justify-between items-center ">
        ...
        <div className="flex  gap-2">
          <div className="flex  -space-x-4">
            ...
            <span
              className="text-sm   rounded-full border-2 border-white w-8 h-8 flex bg-[#F7E8EF] items-center justify-center text-[#6A1039]
