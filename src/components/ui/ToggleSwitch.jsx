...
const ToggleSwitch = ({
  ...
  return (
    <div
      className={`inline-flex  gap-3 items-center py-4  bg-blue rounded-lg border-b border-solid border-b-border  max-w-[483px] min-h-[72px] max-md:max-w-full ${className}`}
    >
      <button
        onClick={onToggle}
